...
export function QuickActionGrid({ items }: { items: QuickActionItem[] }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      {items.map((item) => (
        <Link key={item.label} to={item.to} state={item.state} className="quick-action group">
          <div className="quick-action-icon group-hover:scale-105 transition-transform">
            {item.icon}
          </div>
